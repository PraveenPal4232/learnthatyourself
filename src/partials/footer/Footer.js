...
import GooglePlayImg from "./images/google-play-store.png";
import AppleAppImg from "./images/apple-app-store.png";
    ...
    return (
      <footer>
        <div className="container">
          <div className="row footer-inner text-white mb-4">
